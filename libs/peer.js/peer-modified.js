/* Added peerJsInit function to allow for delayed
 * initialization. This is required for
 * compatibility with Cordova/iosrtc - MLT
 */
function peerJsInit() {
	if(typeof RTCPeerConnection === 'undefined' && typeof webkitRTCPeerConnection !== 'undefined') {
		window.RTCPeerConnection = webkitRTCPeerConnection;
	}
	peerjsUtil.supports = peerjsUtil.getSupported();
}
...
var util = peerjsUtil = {
  ...
  getSupported: function() {
	...
	console.log("WebRTC Features Supported:" +
