...
function setupScene(scene) {
    ...
    var texture0 = texureLoader.load('../textures/shadertoy/pink_granite.jpg');
    texture0.wrapS = THREE.RepeatWrapping;
    texture0.wrapT = THREE.RepeatWrapping;
    
    var texture1 = texureLoader.load('../textures/shadertoy/wood.jpg');
    ...
    var credit = getTextElement("\u201CAbstract Corridor\u201D Shadertoy\nby Shane CC-BY-NC-3.0", 5);
    credit.position.z = -4;
